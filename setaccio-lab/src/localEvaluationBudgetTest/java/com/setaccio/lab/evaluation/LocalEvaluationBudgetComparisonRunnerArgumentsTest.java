    ...
    void parsesBothSavedArmOptionsInEitherOrder() {
        LocalEvaluationBudgetComparisonRunner.Arguments parsed =
                LocalEvaluationBudgetComparisonRunner.Arguments.parse(new String[] {
                        "--budget-256-run-dir", "local/evidence/evaluation-matrix/2026-08-26-budget-256",
                        "--budget-64-run-dir", "local/evidence/evaluation-matrix/2026-08-26-budget-64"
                });

        assertThat(parsed.budget64RunDirectory())
                .isEqualTo("local/evidence/evaluation-matrix/2026-08-26-budget-64");
        assertThat(parsed.budget256RunDirectory())
                .isEqualTo("local/evidence/evaluation-matrix/2026-08-26-budget-256");
    }
