...
public final class LocalEvaluationOfflineRunner {

    private LocalEvaluationOfflineRunner() {}
    ...
    public static void main(String[] args) {
        ...
        LocalEvaluationEvidence evidence = new LocalEvaluationEvidence(
                ...
                catalog,
                review);
        LocalEvaluationEvidence.OfflineResult result = parsed.mode() == Mode.VERIFY
        ...
        if (!result.valid()) {
            ...
            throw new IllegalStateException(
                    "Local evaluation evidence " + parsed.mode().label + " failed with "
                            + result.failures().size() + " issue(s).");
        }
        System.out.println("Local evaluation evidence " + parsed.mode().label + " complete: "
