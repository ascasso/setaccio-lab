...
/** Immutable provenance for the verified R3 raw evidence consumed by an R5 run. */
public record RetrievalAnswerSourceEvidence(
        String sourceRunId,
    ...
    public RetrievalAnswerSourceEvidence {
