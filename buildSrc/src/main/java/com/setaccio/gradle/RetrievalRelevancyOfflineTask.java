...
/** Verifies or regenerates saved R6 relevance evidence without provider access. */
public abstract class RetrievalRelevancyOfflineTask extends DefaultTask {

    private final ExecOperations execOperations;
    private String runDir;

    @Inject
    public RetrievalRelevancyOfflineTask(ExecOperations execOperations) {
