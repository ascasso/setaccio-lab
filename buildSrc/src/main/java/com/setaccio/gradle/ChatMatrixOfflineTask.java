...
public abstract class ChatMatrixOfflineTask extends DefaultTask {

    private final ExecOperations execOperations;
    private String runDir;

    @Inject
    public ChatMatrixOfflineTask(ExecOperations execOperations) {
    ...
    @Option(option = "run-dir", description = "Required saved directory under local/evidence/chat-matrix/.")
