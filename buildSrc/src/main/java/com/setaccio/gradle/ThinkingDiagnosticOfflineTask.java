...
/** Verifies or regenerates saved reasoning diagnostic evidence offline. */
public abstract class ThinkingDiagnosticOfflineTask extends DefaultTask {

    private final ExecOperations execOperations;
    private String runDir;

    @Inject
    public ThinkingDiagnosticOfflineTask(ExecOperations execOperations) {
    ...
    @Option(option = "run-dir", description = "Required saved directory directly under local/evidence/thinking-diagnostic/.")
