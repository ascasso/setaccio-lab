...
/** Verifies or regenerates saved provider-free retrieval evidence. */
public abstract class RetrievalEvaluationOfflineTask extends DefaultTask {

    private final ExecOperations execOperations;
    private String runDir;

    @Inject
    public RetrievalEvaluationOfflineTask(ExecOperations execOperations) {
    ...
    @Option(option = "run-dir", description = "Required saved directory directly under local/evidence/retrieval-evaluation/.")
