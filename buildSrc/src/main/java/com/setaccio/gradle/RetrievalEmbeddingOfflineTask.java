...
/** Verifies or regenerates saved local embedding retrieval evidence offline. */
public abstract class RetrievalEmbeddingOfflineTask extends DefaultTask {

    private final ExecOperations execOperations;
    private String runDir;

    @Inject
    public RetrievalEmbeddingOfflineTask(ExecOperations execOperations) {
