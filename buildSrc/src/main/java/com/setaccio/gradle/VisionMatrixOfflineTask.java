...
public abstract class VisionMatrixOfflineTask extends DefaultTask {

    private final ExecOperations execOperations;
    private String runDir;

    @Inject
    public VisionMatrixOfflineTask(ExecOperations execOperations) {
    ...
    @Option(option = "run-dir", description = "Required saved directory under local/evidence/vision-matrix/.")
