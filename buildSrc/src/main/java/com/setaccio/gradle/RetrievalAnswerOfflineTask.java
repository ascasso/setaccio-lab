...
/** Verifies or regenerates saved R5 answer evidence without provider access. */
public abstract class RetrievalAnswerOfflineTask extends DefaultTask {

    private final ExecOperations execOperations;
    private String runDir;

    @Inject
    public RetrievalAnswerOfflineTask(ExecOperations execOperations) {
    ...
    @Option(option = "run-dir", description = "Required saved directory directly under local/evidence/retrieval-answer/.")
